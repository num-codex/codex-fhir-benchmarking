...
printf "T100-2 - Geschlecht + Diagnose Brustkrebs: "
./evaluate-measure.sh -f t-100/t-100-2.cql ${BASE}

printf "T100-3 - Geschlecht + Diagnose Brustkrebs + Bioprobe: "
./evaluate-measure.sh -f t-100/t-100-3.cql ${BASE}

printf "T100-4 - Geschlecht + Diagnose Brustkrebs + Bioprobe + Laborwert Covid Positiv  : "
./evaluate-measure.sh -f t-100/t-100-4.cql ${BASE}

printf "T100-5 - Geschlecht + Diagnose Brustkrebs + Bioprobe + Laborwert Covid Positiv + Laborwert Hemoglobin (mit Zeitabhängigkeit): "
./evaluate-measure.sh -f t-100/t-100-5.cql ${BASE}

printf "T100-6 - Geschlecht + Diagnose Brustkrebs + Bioprobe + Laborwert Covid Positiv + Laborwert Hemoglobin (mit Zeitabhängigkeit) + Prozedur Bluttransfusion (mit Zeitabhängigkeit):"
